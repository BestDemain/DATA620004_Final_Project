...
def parse_args():
	...
	parser.add_argument("--video_in", default=os.path.join(SCRIPTS_FOLDER, "input.mp4"), help="Run ffmpeg first to convert a provided video file into a set of images. Uses the video_fps parameter also.")
	...
	parser.add_argument("--out", default=os.path.join(SCRIPTS_FOLDER, "transforms.json"), help="Output JSON file path.")
